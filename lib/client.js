...
module.exports = Client = (function() {
  /*
    ...
    parameters:
      ...
      appKey  required
  */
  function Client(host, appId, appKey) {
    if (!(appId || appKey || host)) {
      throw "Requires host, appId and appKey";
    }
    this.server = "https://" + appId + ":" + appKey + "@" + host;
  }
  ...
  */
  ...
  Client.prototype.downloadDocument = function(data, callback) {
    var route,
      _this = this;
    ...
    return request(route, function(err, response, body) {
      return callback(err, response.headers, body);
    });
  };
  ...
  */
  ...
  Client.prototype.addRemoteFile = function(data, callback) {
    ...
    route.method = "PUT";
    this.request(route, data, function(err, cb) {
