...
module.exports = Client = (function() {
  /*
    ...
    parameters:
      ...
      apiKey  required
  */
  function Client(apiId, apiKey) {
    if (!((apiId != null) || (apiKey != null) || (typeof host !== "undefined" && host !== null))) {
      throw "Requires apiId and apiKey";
    }
    this.server = "https://" + apiId + ":" + apiKey + "@" + (conf.get('api:host'));
  }
